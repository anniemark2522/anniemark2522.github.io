...
| **Summary** |
|-------------|
| ผลลัพธ์ที่ได้จากการนำข้อความเข้าฟังก์ชันแฮช หรือเรียกว่า ค่าแฮช  หรือจะเป็นผลลัพธ์จากข้อความที่นำมาสรุปสั้นๆแล้วจากข้อความขนาดใหญ่ ซึ่งจะมีหน้าที่ในการใช้สำหรับยืนยันตรวจสอบข้อมูล ว่าถูกต้องหรือไม่ถูกต้อง ข้อมูลสมบูรณ์หรือไม่ โดยข้อมูลสมบูรณ์จะต้องไม่มีการเปลี่ยนแปลงข้อมูลจริง แต่ message-digest ไม่ได้มีหน้าที่เพื่อป้องกันความลับข้อมูล |
